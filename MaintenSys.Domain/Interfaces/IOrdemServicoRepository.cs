...
public interface IOrdemServicoRepository
{
    ...
    Task<(IReadOnlyList<OrdemServico> Itens, int Total)> BuscarAsync(StatusOrdemServico? status, Guid? tecnicoId, int pagina, int tamanhoPagina, CancellationToken cancellationToken = default);
